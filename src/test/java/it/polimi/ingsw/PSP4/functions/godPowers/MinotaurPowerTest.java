...
public class MinotaurPowerTest {
    ...
    public void powerUsed_punchEnemyWorker() {
        ...
        Actions.selectOption(movePosition);
        workers.replace(startingPlayer, Arrays.asList(movePosition, workers.get(startingPlayer).get(1)));
        workers.replace(enemyPlayer, Arrays.asList(new Coordinates(2,2), workers.get(enemyPlayer).get(1)));
    ...
    public void powerUsed_victoryCondition_gameWon() {
        ...
        Coordinates startingPosition = workers.get(startingPlayer).get(0);
        List<Coordinates> expectedMoveOptions = Arrays.asList(
            new Coordinates(1, 3), new Coordinates(3, 1), new Coordinates(1, 1)
        );
        Coordinates movePosition = new Coordinates(1, 1);
    ...
    public void powerUsed_victoryConditionEnemy_gameNotWon() {
        ...
        Actions.selectOption(movePosition);
        workers.replace(startingPlayer, Arrays.asList(movePosition, workers.get(startingPlayer).get(1)));
        workers.replace(enemyPlayer, Arrays.asList(new Coordinates(0,0), workers.get(enemyPlayer).get(1)));
